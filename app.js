...
const signupCity = document.getElementById("inputcity")
const signupRole = document.getElementById("inputRole")

// console.log(signUpName , signupAddress , signupCity , signupRole)
...
async function signup(){
    ...
    // console.log(name , email, password, address, city, role);
